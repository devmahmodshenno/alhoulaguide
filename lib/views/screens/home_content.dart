import 'dart:async';
import 'package:alhoulaguide/core/app_areas.dart';
...
class _HomeContentState extends State<HomeContent> {
  ...
  // صور محلية ثابتة للمناطق (بما إنها 4 مناطق فقط ونادرًا ما تتغيّر)
      ...
      children: [
        ...
        Expanded(
          child: GridView.count(
            ...
            children: AppAreas.all.map((area) {
              return AreaCard(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => SectionsPage(areaId: area.areaId, areaName: area.areaName),
                    ),
                  );
                },
              );
